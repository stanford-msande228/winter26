...
- [SenseMaker Package in R](https://github.com/carloscinelli/dml.sensemakr)
- [Sensitivity using the DoubleML Package in Python](https://docs.doubleml.org/stable/guide/sensitivity.html)
