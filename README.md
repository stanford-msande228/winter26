...
* [Winter 2025](https://stanford-msande228.github.io/winter25/)
...
Guidance on the allowable use of LLMs in carrying out the homeworks will be listed with each homework. Typically homeworks will ask you to provide an appendix with your LLM prompt and discussion trace that you used when solving a problem set. Some homeworks will request that you generate content with LLMs and criticize it and amend it before presenting the final solution.
